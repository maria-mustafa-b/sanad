...
/** Always-visible path to a human — SANAD is a guide, not the final authority */
      ...
      <div className="flex-1 min-w-0">
        ...
        {!compact && (
          <p className="text-sm text-ink-secondary mt-1 leading-relaxed">
            ...
            A human advisor can explain options in your language — we do not decide legal eligibility.
          </p>
        )}
      </div>
