...
const ACTIVITY = [
  { title: 'Credential issued', meta: 'SANAD-VC-01992 · 2m ago', tone: 'success' as const },
  { title: 'Application submitted', meta: 'APP-2026-9912 · 14m ago', tone: 'info' as const },
  { title: 'Escalation opened', meta: 'Shelter request · 31m ago', tone: 'danger' as const },
  { title: 'Verification check', meta: 'Public portal · 1h ago', tone: 'neutral' as const },
];
