      ...
      <div className="max-w-xl mx-auto px-4 py-8 sm:py-10">
        ...
        {step === 1 && (
          <Card padding="lg" className="space-y-5">
            ...
            <Input label="Mobile (optional)" value={phone} onChange={(e) => setPhone(e.target.value)} placeholder="+971 …" leftIcon="call" />
        ...
        {step === 2 && (
          <Card padding="lg" className="text-center space-y-5">
            ...
            <p className="text-ink-secondary text-sm">
              Next, tell SANAD what happened — or explore services from your dashboard.
            </p>
