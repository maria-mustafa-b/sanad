...
const CHECKLIST = [
  ...
  { id: 'msg', label: 'Message from employer', hint: 'Optional â€” if you have one' },
      ...
      <div className="space-y-6 max-w-3xl pb-8">
        <div>
          ...
          <p className="text-ink-secondary text-sm mt-1 leading-relaxed">
            Only what helps your wage case. Missing papers is OK â€” you can still apply.
          </p>
        </div>
        ...
        <Card className="border-dashed border-2 border-border-strong bg-surface text-center py-10">
          <button type="button" onClick={simulate} className="w-full cursor-pointer">
            ...
            <p className="text-sm text-ink-muted mt-1">PDF, JPG, PNG â€” tap to browse</p>
          </button>
          <Button className="mt-5" loading={analyzing} onClick={simulate}>
            {analyzing ? 'Readingâ€¦' : 'Select file'}
          </Button>
        </Card>
