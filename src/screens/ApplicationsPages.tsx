        ...
        <Card>
          ...
          {step === 1 && (
            <div className="text-sm text-ink-secondary space-y-3">
              <p>Simple checklist â€” add what you have. Missing papers is OK to start.</p>
              <ul className="space-y-2 text-ink">
                <li className="flex gap-2"><span className="text-brand">â˜</span> Salary slip or bank screenshot</li>
                <li className="flex gap-2"><span className="text-brand">â˜</span> Message from employer (if any)</li>
                <li className="flex gap-2"><span className="text-brand">â˜‘</span> Your confirmed situation (already saved)</li>
              </ul>
  ...
  const steps = app?.timeline?.length
    ...
    : [
        ...
        },
        {
          ...
          date: '',
          completed: false,
          description: 'None right now â€” we will tell you if papers are needed.',
        },
        {
          title: 'Next update',
          date: '',
